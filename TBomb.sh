...
echo -e "\e[1;32m UltimateBoomb \e[0m"
...
echo This Script Was Made By SpeedX
...
toilet -f mono12 -F border Siddhart
echo -e "\e[4;34m This Bomber Was Modified By Siddhart \e[0m"
echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
echo -e "\e[1;32m           Mail: tchnspprtr@gmail.com \e[0m"
echo -e "\e[4;32m   YouTube Page: https://bit.ly/3h2Ov7w \e[0m"
echo " "
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By UltimateBoomb'> call.xxx
...
if [[ -s UltimateBoomb/UltimateBoomb.sh ]];then
cd UltimateBoomb
cp -r -f * .. > temp
cd ..
rm -rf  UltimateBoomb >> temp
rm update.speedx >> temp
rm temp
chmod +x UltimateBoomb.sh
fi
echo -e "\e[1;32m UltimateBoomb Will Restart Now..."
...
echo -e "\e[1;32m                   inspired by\e[1;33m"
echo -e "\e[1;33m      [*]  SpeedX   \e[1;31m"
echo "         [-] Mail At: tchnspprtr@gmail.com"
echo ""
echo ""
